  ...
  return <BodyScrollLock>
    <div className="top-0 sm:px-8 overflow-y-auto bottom-0 flex flex-col left-0 right-0 fixed bg-white" style={{ backgroundImage: 'url(/bg-new-light.svg)', backgroundSize: 'cover', zIndex: 201 }}>
      <div className='w-full h-full justify-center'>
        <div className='mx-auto p-8 min-h-full flex flex-col h-fit w-full bg-white justify-between bg-opacity-20' style={{ maxWidth: 800 }}>
          ...
          <div className='flex-col flex mt-4'>
            ...
            <Link href={`/forms/${router.query.id}/form`}>
              <Button color='error' className='w-full bg-red-400 text-white sm:p-4 p-2 self-start border-none mt-2'><ArrowBack className='mr-2' /> Wróć do formularza</Button>
            </Link>
          </div>
        </div>
      </div>
